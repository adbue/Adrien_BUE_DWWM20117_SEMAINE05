    ...
    <div class="col-12">
        ...
        <?php echo form_open(); ?>
                ...
                <div class="form-group">
                    ...
                    <span><?php echo $produit->pro_d_ajout; ?></span>
                </div>
                
                <!-- 11 = date de modification : -->
                <div class="form-group">
                    <label for="date_modif">Date de modification :</label>
                    <span><?php echo $produit->pro_d_modif; ?></span>
                </div> 
        ...
        <div class='mb-3'>
            <a href='form_modifs.php?pro_id=<?php echo $pro_id;?>'><input type="button" class="btn btn-info" value="Modifier"</a>
            <a href='form_suppr.php?pro_id=<?php echo $pro_id;?>'><input type="button" class="btn btn-danger" value="Supprimer"</a>      
